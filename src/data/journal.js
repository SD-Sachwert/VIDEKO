...
export const journalArticles = [
  {
    ...
    featured: true,
    image: imgFehler,
    teaser: 'Neun typische Küchenfehler – und warum nicht jeder davon wirklich ein Fehler ist. Manches gibt einfach der Raum vor. Im Fehlersuche-Spiel zeigen wir dir, worauf es ankommt.',
    ...
    sections: [
      ...
      { h: '7. Am falschen Ende sparen', p: 'Nicht jeder teure Punkt ist automatisch sinnvoll. Aber bei Planung, Montage, Beschlägen und wichtigen Alltagselementen zu sparen, rächt sich oft. Eine Schublade, die nach zwei Jahren hängt, war kein Schnäppchen – sie war ein Versprechen auf späteren Ärger.' },
      { h: '8. Türen statt Auszüge', p: 'Ein Unterschrank mit Tür sieht erstmal völlig normal aus. Im Alltag heißt das aber: öffnen, bücken, in der hintersten Ecke kramen, leise fluchen. Auszüge holen den Inhalt zu dir, statt dich in den Schrank zu schicken – gerade bei tiefen Unterschränken und Hochschränken ist der Unterschied riesig. Ein Muss ist es trotzdem nicht: Auszüge kosten mehr, und bei einem schmalen Budget ist die Tür ein legitimer Kompromiss.' },
      { h: '9. Geräte auf der falschen Höhe', p: 'Ein Backofen knapp über dem Boden bedeutet: Jedes heiße Blech wird zur Kniebeuge. Auf Augenhöhe eingebaut, schont er Rücken und Nerven – und du siehst auch, ob der Auflauf schon braun ist. Das ist selten ein Platzproblem, sondern meistens eine Frage, ob man früh genug daran denkt.' },
      { h: 'Und welche davon sind gar keine Fehler?', p: 'Ehrlich: Nicht jeder Punkt auf dieser Liste ist immer vermeidbar. Ein schmaler Grundriss, eine tragende Wand, ein Fenster genau über der Spüle oder ein begrenztes Budget – manchmal ist die scheinbar „falsche" Lösung schlicht die beste, die der Raum hergibt. Ein echter Planungsfehler entsteht dort, wo man es hätte besser wissen können. Ein guter Kompromiss entsteht dort, wo man bewusst abwägt und das Beste daraus macht. Genau diese Unterscheidung ist der eigentliche Job einer guten Planung – nicht jede Norm abzuhaken, sondern für deinen Raum und deinen Alltag die klügste Lösung zu finden.' },
    ],
    fazit: 'Die besten Küchen wirken später selbstverständlich. Genau das ist der Punkt: Gute Planung fällt nicht auf, schlechte Planung schon. Und ein bewusster Kompromiss ist keine Niederlage, sondern oft die ehrlichste Form von guter Planung.',
  },
  {
