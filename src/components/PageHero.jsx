 ...
 * wenn das Hintergrundbild KI-generiert ist (EU AI Act Art. 50). Mit `aiVariant`
 * lässt sich der Wortlaut präzisieren (z. B. `symbolic` für Personen-Szenen,
 * `visualization` für Räume/Küchen).
 */
export default function PageHero({ kicker, title, lead, image, children, className = '', aiImage = false, aiVariant = 'visualization' }) {
  return (
